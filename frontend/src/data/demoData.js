// ============================================================================
// STATIC MARKETING CONTENT FOR LANDING PAGE
// ============================================================================
...
export const features = [
  ...
  },
  {
    ...
    titleKey: 'features.guidance.title',
    description: 'Get recommendations based on your environmental sensitivity.',
    descriptionKey: 'features.guidance.description',
  },
  {
    key: 'trends',
    icon: 'trending',
    title: 'Historical Trends',
    titleKey: 'features.trends.title',
    description: 'Understand whether air quality is improving or worsening.',
    descriptionKey: 'features.trends.description',
  },
  {
    key: 'alerts',
    icon: 'bell',
