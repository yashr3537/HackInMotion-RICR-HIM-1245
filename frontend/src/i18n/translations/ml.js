export default {
  ...
  nav: {
    home: 'ഹോം',
    features: 'പ്രാധാന്യങ്ങള',
    howItWorks: 'ഇത് എങ്ങനെ പ്രവർത്തിക്കുന്നു',
    about: 'ഞങ്ങളെക്കുറിച്ച്',
    dashboard: 'ഡാഷ్బോർഡ്',
    alerts: 'എലർട്ടുകൾ',
    locations: 'എന്റെ സ്ഥലങ്ങൾ',
    history: 'ചരിത്രം',
    activity: 'പ്രവർത്തന അപകടം',
    routeRisk: 'റൂട്ട് റിസ്ക്',
    compare: 'തോർക്കുക',
    profile: 'പ്രൊഫൈൽ',
  ...
  dashboard: {
    ...
    welcomeAfternoon: 'സുപ്രഭാത സമയം',
    welcomeEvening: 'ശുഭ സന്ധ്യ',
    pollutantBreakdown: 'ദൂഷ്യക വിഭാഗീകരണം',
    myLocations: 'എന്റെ സ്ഥലങ്ങൾ',
    recentAlerts: 'സമീപകാല എലർട്ടുകൾ',
  },
  ...
  alerts: {
    title: 'നിങ്ങളുടെ വായു എലർട്ടുകൾ',
    critical: 'ഗൗരവമേറിയ',
    warning: 'എಚ್ಚരവൈ',
    information: 'വിവരം',
  ...
  aqi: {
    good: 'നല്ലത്',
    moderate: 'മध്യസ്ഥം',
    sensitive: 'സെന്‍സറ്റീവ് ഗ്രൂപ്പുകൾക്ക് അനുകൂലമല്ല',
    unhealthy: 'ആരോഗ്യത്തിന് ഹാനികരമാകാം',
    hazardous: 'ഹാനികരമായ',
  },
  ...
  recommendation: {
    header: 'നിങ്ങളുടെ പരിസ്ഥിതി ശുപാർശ',
    personalized: 'പരിസരനിർവചിതം',
    profile: 'പ്രൊഫൈൽ',
    activity: 'പ്രവർത്തനം',
  ...
  dominant: {
    main: 'പ്രധാന മലിനീകരണ ആശങ്ക',
    currentMetric: 'നിലവിലെ പ്രധാന പരിസ്ഥിതി മാനദണ്ഡം',
    dominantPollutant: 'പ്രധാന മലിനീകരണം',
    exposureRelative: 'പരിധിയോടനുബന്ധിച്ചാണ് കോപ്പുക',
    reference: 'റഫറൻസ്',
  ...
  landing: {
    ...
    clearRiskGuidance: 'സ്പഷ്ടമായ അപകട മാർഗ്ഗനിർദേശം',
    locationAlerts: 'സ്ഥലം അലർട്ട്',
    liveAirQuality: 'ലൈവ് വായു ഗുണനിലവാരം',
    environmentalStatus: 'പരിസ്ഥിതി നില',
