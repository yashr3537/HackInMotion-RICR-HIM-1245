export default {
  ...
  report: {
    title: 'சுற்றுச்சூழல் பிரச்சனையைப் புகார் செய்',
    subtitle: 'உங்கள் பகுதியில் உள்ள சுற்றுச்சூழல் பிரச்சனைகளை ஆவணப்படுத்த உதவவும்.',
    locationHeading: 'இடத் தகவல்',
    autoDetectBtn: 'என் தற்போதைய இடத்தைப் பயன்படுத்து',
    detectingLocation: 'இடம் கண்டறியப்படுகிறது...',
    changeLocationBtn: 'இடத்தை மாற்று',
    manualLocationHeading: 'கைமுறை இடம்',
    cityLabel: 'நகரம் / பகுதி',
    regionLabel: 'மாநிலம் / மண்டலம்',
    addressLabel: 'முகவரி / விவரங்கள் (விருப்பத்தேர்வு)',
    gpsDenied: 'இட அனுமதி மறுக்கப்பட்டது. விவரங்களை உள்ளிடவும்.',
    gpsTimeout: 'இடக் கோரிக்கை நேரம் முடிந்தது.',
    gpsUnsupported: 'உலாவி ஜிபிஎஸ் ஆதரிக்கவில்லை.',
    categoryLabel: 'பிரச்சனை வகை',
    selectCategory: 'வகை ஒன்றைத் தேர்ந்தெடுக்கவும்...',
    cat_industrial_smoke: 'தொழிற்சாலை புகை',
    cat_vehicle_pollution: 'வாகன புகை',
    cat_garbage_burning: 'குப்பை எரிப்பு',
    cat_waste_dump: 'கழிவு கொட்டுமிடம்',
    cat_dust_pollution: 'தூசி மாசு',
    cat_construction_dust: 'கட்டுமான தூசி',
    cat_chemical_smell: 'ரசாயன வாசனை',
    cat_factory_emission: 'ஆலை உமிழ்வு',
    cat_tree_cutting: 'மரம் வெட்டுதல்',
    cat_other: 'மற்றவை',
    severityLabel: 'தீவிர நிலை',
    sev_low: 'குறைந்த',
    sev_medium: 'மிதமான',
    sev_high: 'அதிக',
    sev_critical: 'மிகவும் தீவிரமானது',
    descriptionLabel: 'பிரச்சனையை விவரிக்கவும்',
    descriptionPlaceholder: 'ஒவ்வொரு மாலையும் தொழிற்சாலையிலிருந்து அதிக புகை வருகிறது...',
    descriptionMinErr: 'விளக்கம் குறைந்தது 10 எழுத்துகள் இருக்க வேண்டும்.',
    healthImpactLabel: 'ஆரோக்கிய பாதிப்பு',
    healthNotice: 'சுகாதார விவரங்கள் தகவல் நோக்கத்திற்காக மட்டுமே சேகரிக்கப்படுகின்றன.',
    hp_breathing_difficulty: 'மூச்சுத்திணறல்',
    hp_allergy: 'அலர்ஜி / கண் எரிச்சல்',
    hp_eye_irritation: 'கண் எரிச்சல்',
    hp_headache: 'தலைவலி',
    hp_cough: 'தொடர் இருமல்',
    hp_chest_pain: 'நெஞ்சு அசௌகரியம்',
    hp_other: 'இதர அறிகுறிகள்',
    photoUploadLabel: 'புகைப்பட ஆதாரம் பதிவேற்றவும் (JPEG, PNG, WEBP — max 10MB)',
    videoUploadLabel: 'வீடியோ ஆதாரம் பதிவேற்றவும் (MP4, WEBP, MOV — max 50MB)',
    chooseFile: 'கோப்பைத் தேர்வு செய்',
    removeFile: 'கோப்பை நீக்கு',
    dateTimeLabel: 'நிகழ்வு தேதி மற்றும் நேரம்',
    contactHeading: 'தொடர்பு விவரங்கள்',
    contactName: 'உங்கள் பெயர்',
    contactEmail: 'மின்னஞ்சல் முகவரி',
    contactPhone: 'தொலைபேசி எண் (விருப்பத்தேர்வு)',
    submitAnonymously: 'பெயர் குறிப்பிடாமல் சமர்ப்பிக்கவும்',
    anonymousNotice: 'உங்கள் அடையாளம் பாதுகாப்பாக வைக்கப்படும்.',
    submitBtn: 'மாசு புகாரைச் சமர்ப்பி',
    submittingBtn: 'சமர்ப்பிக்கப்படுகிறது...',
    successTitle: 'புகார் வெற்றிகரமாக சமர்ப்பிக்கப்பட்டது',
    successSubtitle: 'சமூகத்தைச் சுத்தமாக வைத்திருக்க உதவியதற்கு நன்றி.',
    reportIdLabel: 'புகார் ஐடி',
    statusLabel: 'தொடக்க நிலை',
    viewMyReportsBtn: 'என் புகார்களைப் பார்',
    backToDashboardBtn: 'டாஷ்போர்டுக்குத் திரும்பு',
    newReportBtn: 'மற்றொரு புகாரைச் சமர்ப்பி',
  },

  myReports: {
    title: 'என் மாசு புகார்கள்',
    subtitle: 'நீங்கள் சமர்ப்பித்த புகார்களின் நிலையைக் கண்காணிக்கவும்.',
    noReports: 'இன்னும் புகார்கள் எதுவும் சமர்ப்பிக்கப்படவில்லை.',
    noReportsDesc: 'சுற்றுச்சூழல் பிரச்சனைகளைப் புகாரளித்து உங்கள் பகுதியைப் பாதுகாக்கவும்.',
    reportIssueBtn: 'புதிய பிரச்சனை புகார் செய்',
    colId: 'புகார் ஐடி',
    colLocation: 'பகுதி / நகரம்',
    colCategory: 'வகை',
    colSeverity: 'தீவிரம்',
    colStatus: 'நிலை',
    colDate: 'தேதி',
  ...
  reportDetails: {
    ...
    backBtn: 'என் புகார்களுக்குத் திரும்பு',
    timelineHeading: 'நிலை முன்னேற்றம்',
    locationDetails: 'இட விவரங்கள்',
    evidenceHeading: 'புகைப்பட & வீடியோ ஆதாரம்',
    noEvidence: 'ஊடக ஆதாரம் எதுவும் பதிவேற்றப்படவில்லை.',
    contactInfo: 'தொடர்பு விவரங்கள்',
    anonymousUser: 'பெயர் குறிப்பிடாமல் சமர்ப்பிக்கப்பட்டது',
    submittedOn: 'புகாரளிக்கப்பட்ட தேதி',
    updatedOn: 'கடைசி புதுப்பிப்பு',
